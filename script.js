document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // Optional: show a submitting state
      ...
      if (submitBtn) {
        ...
        if (submitBtn.tagName === 'BUTTON') {
          submitBtn.textContent =
            submitBtn.dataset.submittingText || 'Sending...';
        } else {
          submitBtn.value = submitBtn.dataset.submittingText || 'Sending...';
        }

        // Re-enable after a timeout as a fallback
        setTimeout(function () {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מה אוכלים היום? משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'af606654-1bdd-4e69-b534-42f4382c98fe',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'af606654-1bdd-4e69-b534-42f4382c98fe';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'af606654-1bdd-4e69-b534-42f4382c98fe';
